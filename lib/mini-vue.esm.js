...
function resolveAsset(type, name) {
    ...
    if (!instance)
        return name;
    const res = instance.appContext[type][name];
    return res === undefined ? instance.type : res;
}
...
export { computed, createApp, createRenderer, createTextVNode, effect, getCurrentInstance, h, inject, nextTick, provide, proxyRefs, reactive, readonly, ref, renderSlots, renderer, resolveComponent, shallowReadonly };
